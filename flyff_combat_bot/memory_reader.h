...
namespace flyff
{
	...
	class player
	{
		public:
			...
			void setup_initial_target_hp(const flyff::process &process);
			void update_target_hp();
			...
			//{
			//	std::cout << "player parameterized constructor invoked\n";
			//}
			...
			player &operator=(const player &other)
			{
				if (this != &other)
				{
					...
					//std::cout << "player copy assignment operator invoked\n";
				}
				return *this;
			}
			...
			player &operator=(player &&other) noexcept
			{
				if (this != &other)
				{
					...
					//std::cout << "player move assignment operator invoked\n";
				}
				return *this;
			}
		...
		private:
			...
			LPVOID target_hp_address = nullptr;
			...
			std::array<unsigned char, 322> hp_byte_pattern{
	...
	class monster
	{
		public:
			...
			monster(const monster &other) :
				...
				order(other.order)
			{
				std::cout << "monster copy constructor invoked\n";
			}
			...
			monster &operator=(const monster &other)
			{
				if (this != &other)
				{
					...
					std::cout << "monster copy assignment operator invoked\n";
				}
				return *this;
			}
			...
			{
				//std::cout << "monster move constructor invoked\n";
			}
			...
			monster &operator=(monster &&other) noexcept
			{
				if (this != &other)
				{
					...
					//std::cout << "monster move assignment operator invoked\n";
				}
				return *this;
			}
